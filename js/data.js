...
const WORKOUTS = {
  ...
  C: {
    ...
    exercises: [
      ...
      { id: "dips",    name: "Tricep Dips",                target: "4×12–15",     sets: 4, unit: "reps",
        cues: ["Hands shoulder-width on bench/chair, fingers forward", "Elbows straight back — not flared out", "Lower to 90° — no bouncing", "Bodyweight first. Add backpack weight when 4×15 feels clean"],
        search: "tricep bench dips" },
      ...
      { id: "sdbcurl", name: "Seated DB Curl",             target: "3×12",        sets: 3, unit: "lb",
        cues: ["Back against the bench — no swinging", "Full stretch at bottom, squeeze at top", "Slow 2-sec lower", "Strict form beats heavy weight here"],
        search: "seated dumbbell curl form" },
    ],
  },
  D: {
